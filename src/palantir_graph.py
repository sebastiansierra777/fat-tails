# %%---------------------------------------------------------------------
# PALANTIR HISTOGRAM + NORMAL PDF OVERLAY
import numpy as np
import pandas as pd
...
# Load the data
df = pd.read_excel(excel_path, sheet_name="palantir_log")
...
ax.set_xlabel("Palantir Daily Log Returns", fontsize=12)
ax.set_ylabel("Probability Density", fontsize=12)
ax.set_title("PLTR: Empirical Distribution vs Fitted Normal Density", fontsize=14)
